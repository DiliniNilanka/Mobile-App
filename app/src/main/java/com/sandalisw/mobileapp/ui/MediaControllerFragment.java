...
import com.sandalisw.mobileapp.analytics.SongAnalytics;
import com.sandalisw.mobileapp.analytics.UserAnalytics;
...
public class MediaControllerFragment extends Fragment implements View.OnClickListener {
    ...
    private List<SongR> songs = MainActivity.songAppDatabase.songDao().getSongs();
    ...
    public void setMediaData(MediaMetadataCompat mediaItem){
        ...
        //Toast.makeText(getActivity(),String.valueOf(tsLong),Toast.LENGTH_SHORT).show();

        SaveData.saveSongs(mediaItem);
        SongAnalytics.songAnalytics(mediaItem);
        UserAnalytics.userHistry(mediaItem);
        UserAnalytics.userSongPreferences(mediaItem);
