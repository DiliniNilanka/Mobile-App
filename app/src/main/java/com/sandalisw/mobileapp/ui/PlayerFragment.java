...
public class PlayerFragment extends Fragment{
    ...
    private void setView(MediaMetadataCompat mdata) {
        ...
        //String songname = mdata.getDescription().getTitle().toString();
        //String artistname = mdata.getDescription().getSubtitle().toString();
        //String thumbnailurl = mdata.getDescription().getIconUri().toString();


        //SongR songR = new SongR(songname, artistname, thumbnailurl);
        //Toast.makeText(getActivity(), songR.getSongname(), Toast.LENGTH_SHORT).show();
