...
import com.sandalisw.mobileapp.adapters.RecentlyPlayedSongAdapter;
...
public class HomeFragment extends Fragment implements RecentSongAdapter.SongListener, RecentlyPlayedSongAdapter.RecentSongListener{
    ...
    private void initRecyclerView(View view){
        ...
        songAdapter_recently_played = new RecentSongAdapter(getActivity(), this,1);
        LinearLayoutManager layoutManager3 = new LinearLayoutManager(getActivity(), HORIZONTAL, false);
        recyclerView_recently_played.setLayoutManager(layoutManager3);
        //songAdapter_recently_played.setDataList(MainActivity.songAppDatabase.songDao().getSongs());
    ...
    private void subscribeObservers(){
        mSongViewModel.getSongs().observe(this,new Observer<TopSongsResponse>(){
            ...
            public void onChanged(@Nullable TopSongsResponse mData) {
                ...
                addtolibrary(AccessRoomData.getRecentlyPlayedSongs());
                //
